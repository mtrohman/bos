...
@section('titleBar', "Tambah Sekolah")
            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{route('admin.sekolah.store')}}">
                                @csrf                                
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="name" class="form-control" name="name" required placeholder="Masukkan Nama" value="">
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            <label class="m-0" for="npsn">Npsn</label>
                                            <input type="text" id="npsn" class="form-control" name="npsn" required placeholder="Masukkan Npsn" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="telepon" class="form-control" name="telepon" required placeholder="Masukkan Nomor Telepon" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="desa" class="form-control" name="desa" required placeholder="Masukkan Desa" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="alamat" class="form-control" name="alamat" required placeholder="Masukkan Alamat" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="nama_kepsek" class="form-control" name="nama_kepsek" required placeholder="Masukkan Nama Kepala Sekolah" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="nip_kepsek" class="form-control" name="nip_kepsek" required placeholder="Masukkan NIP Kepala Sekolah" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="nama_bendahara" class="form-control" name="nama_bendahara" required placeholder="Masukkan Nama Bendahara" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-1">
                                            ...
                                            <input type="text" id="nip_bendahara" class="form-control" name="nip_bendahara" required placeholder="Masukkan NIP Bendahara" value="">
                                        </div>
                                    </div>
